...
?>
  <tr>
    ...
    <td><div align="center"><?php echo $result["Status"];?></div></td>
	  <td align="center"><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='delete.php?UserID=<?php echo $result["UserID"];?>';}">Delete</a></td>
  </tr>
<?php
}
?>
